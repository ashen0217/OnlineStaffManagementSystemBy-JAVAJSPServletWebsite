    ...
    <div class="container">
        <div class="form-container mt-5">
            ...
            <form action="UpdateTransportServlet" method="post">
                ...
                <div class="mb-3">
                	<label>Bus no</label>
                    <input type="text" class="form-control" name="BNo" placeholder="BusNo" required value="<%= busNo %>">
                </div>
                <div class="mb-3">
                	<label>Condition</label>
                    <input type="text" class="form-control" name="condt" placeholder="condition" required value="<%= condition %>">
                </div>
                	<label>Driver NIC</label>
                <div class="mb-3">
                    <input type="text" class="form-control" name="Dnic" placeholder="Driver NIC" required value="<%= Dname %>">
                </div>
                <div class="mb-3">
                	<label>Number of passengers</label>
                    <input type="text" class="form-control" name="noOfpass" placeholder="No of passengers" required value="<%= noOfpass %>">
                </div>
                <div class="mb-3">
                	<label>Start location</label>
                    <input type="text" class="form-control" name="statloc" placeholder="StartLocation" required value="<%= statloc %>">
                </div>
                <div class="mb-3">
                	<label>End location</label>
                    <input type="text" class="form-control" name="endloc" placeholder="EndLocation" required value="<%= endloc %>">
                </div>
